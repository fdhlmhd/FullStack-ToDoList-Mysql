      ...
      <div class="row">
        <div class="col-md-6 mx-auto">
          ...
          <form v-on:submit.prevent="addNewTask">
            <label for="tasknameinput">Mau Ngapain ?</label>
            <br>
            <label for="tasknameinput">Kalau Udah Beres Di Delete Aja Ya</label>
            <input v-model="taskname" id="tasknameinput" class="form-control" placeholder="Ketik Disini">
